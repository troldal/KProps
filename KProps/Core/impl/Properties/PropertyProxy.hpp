...
namespace pcprops
{
    ...
    class DynamicProperties : public PropertiesBase<DynamicProperties<TYPE>>
    {
        ...
        std::vector<TYPE> m_properties { };

    public:
        explicit DynamicProperties(IFluid fluid, std::vector<TYPE> properties, bool isValid = true)
        ...
        auto get() &&
        {
            ...
            for (auto prop : m_properties)
                container.emplace_back(BASE::m_fluid.template property<UNITS_T>(prop));
